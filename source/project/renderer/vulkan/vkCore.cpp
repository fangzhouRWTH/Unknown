...
namespace unknown::renderer::vulkan
{
    ...
    void VulkanCore::init_default_data()
    {
        ...
        // load meshes
        {
            ...
            std::string modelPath = "/home/fzl/workspace/git_projects/RenderEngineV0/assets/models/structure/structure.glb";
            ...
            for (auto n : nodes)
            {
                if (n->type == asset::SceneContentType::Mesh)
                {
                    ...
                    mMeshBank.meshInfos.find(meshHandle);

                    if (mMeshBank.meshInfos.find(meshHandle) != mMeshBank.meshInfos.end())
                        continue;
                    ...
                    mMeshBank.meshInfos.insert({meshInfo.meshDataHandle, meshInfo});
                }
            }
            ...
            for (auto meshInfo : mMeshBank.meshInfos)
            {
